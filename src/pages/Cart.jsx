...
function Cart() {
  ...
  const onRemoveCartItem = (id) => {
    if (window.confirm("Do you want to remove cart item?")) {
    ...
    <div className="container container--cart">
      {totalCount ? (
          ...
          <div className="content__items">
            {addedPizzas.map((obj) => (
              <CartItem
                ...
                type={obj.type}
                size={obj.size}
                nameTotalPrice={items[obj.id].nameTotalPrice}
                nameTotalCount={items[obj.id].items.length}
        ...
        <div className="cart cart--empty">
          ...
          <p>
            You haven't put in an order for any pizza yet.
            <br />
            Please go to the main page to make the order.
          </p>
